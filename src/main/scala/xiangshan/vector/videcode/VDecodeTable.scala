...
object VADecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VREDMAX_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMAXU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMIN_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMINU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDOR_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
...
object VNDecode extends VDecodeConstants{
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMADC_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VIM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VVM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VXM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VVM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VXM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),

    VMSEQ_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSEQ_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSEQ_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGT_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGT_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGTU_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGTU_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLE_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLE_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLEU_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLEU_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLEU_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLT_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLT_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLTU_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLTU_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSNE_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSNE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSNE_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFEQ_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFEQ_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFGE_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFGT_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLE_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLT_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLT_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFNE_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFNE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
  )
}
