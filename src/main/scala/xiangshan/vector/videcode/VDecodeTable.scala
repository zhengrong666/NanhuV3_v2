...
object VLDecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VLM_V -> List(EewVal.byte, EewVal.dc, EewVal.mask, EewType.const, EewType.dc, EewType.const, EmulVal.dc, EmulType.lmul, N, Y, N, Y, N, N),
...
object VSDecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VSM_V -> List(EewVal.dc, EewVal.dc, EewVal.byte, EewType.dc, EewType.dc, EewType.const, EmulVal.dc, EmulType.lmul, N, Y, N, N, N, N),
...
object VADecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMV_S_X -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, N, N, N),
    ...
    VFobject_V -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sew, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    ...
    VFMV_F_S -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, N, N, N),
    ...
    //reduction-float
    VFREDMAX_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.sew, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, N),
    VFREDMIN_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.sew, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, N),
    VFREDOSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.sew, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, N),
    VFREDUSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.sew, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, N),
    ...
    //mask
    VMXNOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMXOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMAND_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMANDN_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMNAND_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMNOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMORN_MM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),

    VFIRST_M -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VCPOP_M -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMSBF_M -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMSIF_M -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMSOF_M -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    ...
    //reduction
    VREDAND_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMAX_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMAXU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMIN_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDMINU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDOR_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
    VREDXOR_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),
...
object VWDecode extends VDecodeConstants{
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VWADD_WX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    ...
    VWADDU_WX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    ...
    VWSUB_WX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    ...
    VWSUBU_WX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    ...
    VFWADD_WF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    ...
    VFWSUB_WF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    ...
    VWREDSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sewm2, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    VWREDSUMU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sewm2, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
    VFWREDOSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sewm2, EewType.sewm2, EmulVal.dc, EmulType.lmul, Y, N, N, N, Y, N),
    VFWREDUSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sewm2, EewType.sewm2, EmulVal.dc, EmulType.lmul, N, N, N, N, Y, N),
  )
}
...
object VNDecode extends VDecodeConstants{
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMADC_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VIM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VVM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMADC_VXM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VVM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSBC_VXM -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),

    VMSEQ_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSEQ_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSEQ_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGT_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGT_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGTU_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSGTU_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLE_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLE_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLE_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLEU_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLEU_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLEU_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLT_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLT_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLTU_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSLTU_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSNE_VI -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSNE_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMSNE_VX -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFEQ_VF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFEQ_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFGE_VF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFGT_VF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLE_VF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLE_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLT_VF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFLT_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFNE_VF -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
    VMFNE_VV -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.sew, EewType.sew, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, N, N, N, Y),
  )
}
