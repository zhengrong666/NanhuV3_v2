...
object VADecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    //mask
    VMXNOR_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMXOR_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMAND_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMANDN_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMNAND_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMNOR_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMOR_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMORN_MM -> List(EewVal.mask, EewVal.mask, EewVal.mask, EewType.const, EewType.const, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),

    VFIRST_M -> List(EewVal.dc, EewVal.mask, EewVal.dc, EewType.dc, EewType.const, EewType.dc, EmulVal.r1, EmulType.const, N, N, N, N, N, N),
    VCPOP_M -> List(EewVal.dc, EewVal.mask, EewVal.dc, EewType.dc, EewType.const, EewType.dc, EmulVal.dc, EmulType.lmul, Y, N, Y, N, N, N),
