...
object VADecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VFMV_F_S -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.sew, EmulVal.r1, EmulType.const, N, N, N, N, N, N),
    VFMV_S_F -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.sew, EmulVal.r1, EmulType.const, N, N, N, N, N, N),
    VFMV_V_F -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.sew, EmulVal.dc, EmulType.lmul, N, N, N, N, N, N),

    //reduction-float
    VFREDMAX_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VFREDMIN_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VFREDOSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VFREDUSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    ...
    //mask
    VMXNOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMXOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMAND_MM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMANDN_MM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMNAND_MM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMNOR_MM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    ...
    VMSBF_M -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMSIF_M -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    VMSOF_M -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, N, N, Y, N, N),
    ...
    //reduction
    VREDAND_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDMAX_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDMAXU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDMIN_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDMINU_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDOR_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDSUM_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VREDXOR_VS -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.const, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    ...
    VMV_S_X -> List(EewVal.dc, EewVal.dc, EewVal.dc, EewType.dc, EewType.dc, EewType.sew,  EmulVal.r1, EmulType.const, N, N, N, N, N, N),
...
object VNDecode extends VDecodeConstants{
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMADC_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMADC_VIM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMADC_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMADC_VVM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMADC_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMADC_VXM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSBC_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSBC_VVM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSBC_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSBC_VXM -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),

    VMSEQ_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSEQ_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSEQ_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSGT_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSGT_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSGTU_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSGTU_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLE_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLE_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLEU_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLEU_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLEU_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLT_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLT_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLTU_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSLTU_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSNE_VI -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSNE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMSNE_VX -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFEQ_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFEQ_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFGE_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFGT_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFLE_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFLE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFLT_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFLT_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFNE_VF -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.dc, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
    VMFNE_VV -> List(EewVal.dc, EewVal.dc, EewVal.mask, EewType.sew, EewType.sew, EewType.const, EmulVal.dc, EmulType.lmul, Y, N, N, Y, N, N),
  )
}
