...
object VLDecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VLM_V -> List(EewVal.byte, EewVal.dc, EewVal.dc, EewType.const, EewType.dc, EewType.scalar, EmulVal.r1, EmulType.const, N, Y, N, Y, N, N),
...
object VSDecode extends VDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    VS1R_V -> List(EewVal.byte, EewVal.dc, EewVal.dword, EewType.const, EewType.dc, EewType.const, EmulVal.r1, EmulType.const, N, Y, N, N, N, N),
    VS2R_V -> List(EewVal.byte, EewVal.dc, EewVal.dword, EewType.const, EewType.dc, EewType.const, EmulVal.r2, EmulType.const, N, Y, N, N, N, N),
    VS4R_V -> List(EewVal.byte, EewVal.dc, EewVal.dword, EewType.const, EewType.dc, EewType.const, EmulVal.r4, EmulType.const, N, Y, N, N, N, N),
    VS8R_V -> List(EewVal.byte, EewVal.dc, EewVal.dword, EewType.const, EewType.dc, EewType.const, EmulVal.r8, EmulType.const, N, Y, N, N, N, N),
