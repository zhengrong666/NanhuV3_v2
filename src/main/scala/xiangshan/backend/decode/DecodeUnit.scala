...
object VectorArithDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VCPOP_M -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vmask, FuOpType.X, Y, N, N, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VID_V -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vmask, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
...
object VectorNarrowDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    //narrowing
    VNSRA_WI -> List(SrcType.imm, SrcType.vec, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.IMM_VA),
    VNSRA_WV -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VNSRA_WX -> List(SrcType.reg, SrcType.vec, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VNSRL_WI -> List(SrcType.imm, SrcType.vec, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.IMM_VA),
    VNSRL_WV -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VNSRL_WX -> List(SrcType.reg, SrcType.vec, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    ...
    VFNCVT_F_F_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_F_X_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_F_XU_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_ROD_F_F_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_RTZ_X_F_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_RTZ_XU_F_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_X_F_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
    VFNCVT_XU_F_W -> List(SrcType.vec, SrcType.vec, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow, SelImm.X),
