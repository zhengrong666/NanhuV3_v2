...
object VectorArithDecode extends DecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VSEXT_VF2 -> List(SrcType.DC, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSEXT_VF4 -> List(SrcType.DC, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSEXT_VF8 -> List(SrcType.DC, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    ...
    VZEXT_VF2 -> List(SrcType.DC, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VZEXT_VF4 -> List(SrcType.DC, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VZEXT_VF8 -> List(SrcType.DC, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
