...
//   // This X should be used only in 1-bit signal. Otherwise, use->List(SrcType.fp,  SrcType.imm, SrcType.vec, FuType.fmisc, FuOpType.X, N, Y, N, N, N, N, SelImm.IMM_X),
//   def X = BitPat("b?")
//   def N = BitPat("b0")
//   def Y = BitPat("b1")
...
object VectorStoreDecode extends DecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VSE16_V -> List(SrcType.reg, SrcType.DC, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSE32_V -> List(SrcType.reg, SrcType.DC, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSE64_V -> List(SrcType.reg, SrcType.DC, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSE8_V -> List(SrcType.reg, SrcType.DC, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSM_V -> List(SrcType.reg, SrcType.DC, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSOXEI16_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSOXEI32_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSOXEI64_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSOXEI8_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSSE16_V -> List(SrcType.reg, SrcType.reg, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSSE32_V -> List(SrcType.reg, SrcType.reg, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSSE64_V -> List(SrcType.reg, SrcType.reg, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSSE8_V -> List(SrcType.reg, SrcType.reg, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSUXEI16_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSUXEI32_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSUXEI64_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
    VSUXEI8_V -> List(SrcType.reg, SrcType.vec, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, N, N, N, SelImm.IMM_X),
