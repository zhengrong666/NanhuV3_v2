...
object VectorArithDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VFMV_S_F -> List(SrcType.fp, SrcType.X, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMV_V_F -> List(SrcType.fp, SrcType.X, SrcType.X, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
