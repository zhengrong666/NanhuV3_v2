...
object VectorArithDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMV_S_X -> List(SrcType.reg, SrcType.X, SrcType.X, FuType.s2v, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMV_V_I -> List(SrcType.imm, SrcType.X, SrcType.X, FuType.s2v, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.IMM_VA),
    VMV_V_V -> List(SrcType.vec, SrcType.X, SrcType.X, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMV_V_X -> List(SrcType.reg, SrcType.X, SrcType.X, FuType.s2v, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VFMV_F_S -> List(SrcType.vec, SrcType.X, SrcType.X, FuType.vfp, FuOpType.X, N, Y, N, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMV_S_F -> List(SrcType.fp, SrcType.X, SrcType.X, FuType.s2v, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMV_V_F -> List(SrcType.fp, SrcType.X, SrcType.X, FuType.s2v, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
...
object VectorStoreDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VSE16_V -> List(SrcType.reg, SrcType.X, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VSE32_V -> List(SrcType.reg, SrcType.X, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VSE64_V -> List(SrcType.reg, SrcType.X, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VSE8_V -> List(SrcType.reg, SrcType.X, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VSM_V -> List(SrcType.reg, SrcType.X, SrcType.vec, FuType.stu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
...
object VectorConfDecode extends DecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VSETIVLI ->List(SrcType.imm,  SrcType.imm, SrcType.X, FuType.csr, FuOpType.X, Y, N, N, N, N, N, SelImm.IMM_CI),
...
//    ++ SvinvalDecode.table
  ...
  val cs = WireInit(0.U.asTypeOf(new CtrlSignals()))
  cs := cs.decode(ctrl_flow.instr, decode_table)
