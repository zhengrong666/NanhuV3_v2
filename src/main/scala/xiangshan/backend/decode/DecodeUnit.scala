...
object VectorArithDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMAX_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMAX_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMAXU_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMAXU_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMERGE_VIM -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMERGE_VVM -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VMIN_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMIN_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VMINU_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VSEXT_VF2 -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VSEXT_VF4 -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VSEXT_VF8 -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VZEXT_VF2 -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VZEXT_VF4 -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VZEXT_VF8 -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VFADD_VV ->List(SrcType.vec,  SrcType.vec, SrcType.DC, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VFMACC_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMACC_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMADD_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMADD_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VFMSAC_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMSAC_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMSUB_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFMSUB_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    ...
    VFNMACC_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMACC_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMADD_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMADD_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMSAC_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMSAC_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMSUB_VF ->List(SrcType.fp,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
    VFNMSUB_VV ->List(SrcType.vec,  SrcType.vec, SrcType.vec, FuType.vfp, FuOpType.X, N, N, Y, N, Widen.NotWiden, Narrow.NotNarrow, SelImm.X),
...
object VectorNarrowDecode extends VIDecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    VMADC_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMADC_VIM -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMADC_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMADC_VVM -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    ...
    VMSBC_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSBC_VVM -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    ...
    VMSEQ_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSEQ_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSEQ_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSGT_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSGT_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSGTU_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSGTU_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLE_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLE_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLE_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLEU_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLEU_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLEU_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLT_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLT_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLTU_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSLTU_VX -> List(SrcType.reg, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSNE_VI -> List(SrcType.imm, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMSNE_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.valu, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    ...
    VMFEQ_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.vmac, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    ...
    VMFLE_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.vmac, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMFLT_VF -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.vmac, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMFLT_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.vmac, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMFNE_VF -> List(SrcType.fp, SrcType.vec, SrcType.DC, FuType.vmac, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X),
    VMFNE_VV -> List(SrcType.vec, SrcType.vec, SrcType.DC, FuType.vmac, FuOpType.X, N, N, Y, Y, Widen.NotWiden, Narrow.Narrow2, SelImm.X)
  )
}
